...
set search_path = croissant, public;
...
2	curious_chloe	Chloe	https://imgur.com/AwS5vPC.jpg	female	Chloe	Lee	🏹 Saggitarius\n✈ Tokyo, Amsterdam, and Brooklyn\n🏠 Living in Sydney\n🍜 Ramen, Pad Thai, and Boba is Lyf	2	5	c-MEMEQ0loY:APA91bH-k9yjCoRA66ek1uSga86caeEsTtmzsqrGcutQ0t1Wls7vqcj3x-E1dvmnKkheOJ5-fkCpX1Pwys7KpRxOQ6kPNXkdz4qO4W64xXf7TjGyuy8DtrrCg0R7eL1jRFOa2co_Y7QK	\N
...
SELECT pg_catalog.setval('croissant.post_photos_id_seq', 401, true);
...
SELECT pg_catalog.setval('croissant.post_reviews_id_seq', 237, true);
...
SELECT pg_catalog.setval('croissant.posts_id_seq', 246, true);
